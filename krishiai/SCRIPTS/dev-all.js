...
const services = [
  { name: 'Farmer', port: 5173, cmd: 'npm', args: ['run', 'dev', '--workspace=@krishiai/farmer'], color: '\x1b[32m' },
  { name: 'Vendor', port: 5174, cmd: 'npm', args: ['run', 'dev', '--workspace=@krishiai/vendor'], color: '\x1b[36m' },
  { name: 'Admin ', port: 5175, cmd: 'npm', args: ['run', 'dev', '--workspace=@krishiai/admin'], color: '\x1b[35m' }
];
