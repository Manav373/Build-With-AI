...
function StatCard({ icon: Icon, label, value, subtitle, color, trend, delay = 0 }) {
  return (
    ...
    >
      ...
      <p style={{ fontSize: '1.5rem', fontWeight: 900, color: '#fff', fontFamily: "'Outfit', sans-serif", lineHeight: 1 }}>
        {value}
      </p>
      ...
      {subtitle && (
        <p style={{ fontSize: '0.7rem', color: `${color}90`, fontWeight: 600, marginTop: 2 }}>
          {subtitle}
        </p>
      )}
    </motion.div>
