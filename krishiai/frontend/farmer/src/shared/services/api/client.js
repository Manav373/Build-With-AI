/**
 * shared/services/api/client.js — Universal KrishiAI HTTP Client
 * ---------------------------------------------------------------
...
class UniversalApiClient {
  constructor() {
    this.baseUrl = API_BASE.endsWith('/') ? API_BASE.slice(0, -1) : API_BASE;
  }
  ...
  async request(endpoint, options = {}) {
    ...
    const domain = localStorage.getItem('krishi_active_domain') || 'farmer';
