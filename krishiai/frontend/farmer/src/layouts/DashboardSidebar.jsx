...
import { LayoutDashboard, Map, TrendingUp, Sparkles, HelpCircle, Settings, Plus, MessageSquare, Trash2, Edit2, Check, Home, BarChart2, Satellite, Phone, Mic, Users, Globe, ChevronDown, Sun, Moon, ShoppingBag, Store, Wheat, Cpu } from 'lucide-react';
...
export default function DashboardSidebar({ currentPath = '/chat', onAction, onClose, chatSessions = [], currentChatId, onNewChat, onSelectChat, onDeleteChat, onRenameChat, language = 'en', onLanguageChange }) {
  ...
  const intelligenceItems = [
    { id: 'iot', icon: <Cpu size={18} />, label: t.iot || 'IoT Smart Farm (Kisan Alert)', path: '/iot', active: currentPath === '/iot' },
