export const hi = {
  ...
  platformFeatures: {
    ...
    items: {
      vendors: {
        title: 'कृषि मार्केटप्लेस व फसल बिक्री',
        desc: 'बीज, उर्वरक, उपकरण विक्रेताओं से सीधे जुड़ें और अपनी फसल बिना बिचौलियों के बेचें।',
        badge: 'मार्केटप्लेस',
        route: '/vendors'
      },
      voice: {
        title: 'वॉइस असिस्टेंस (Hands-Free)',
        desc: '15+ भारतीय भाषाओं में वास्तविक समय वॉइस सलाहकार के साथ आसानी से बात करें।',
        badge: 'वॉइस AI',
        route: '/voice-assistant'
      },
      community: {
        title: 'किसान समुदाय नेटवर्क',
        desc: 'भारत भर के 10,000+ किसानों के साथ अपने अनुभव साझा करें और समस्याओं का समाधान पाएं।',
        badge: 'कम्युनिटी',
        route: '/community'
      },
      satellite: {
        title: 'सैटेलाइट NDVI स्वास्थ्य',
        desc: 'सैटेलाइट इमेजरी का उपयोग करके रीयल-टाइम फसल स्वास्थ्य और नमी की निगरानी।',
        badge: 'सैटेलाइट',
        route: '/satellite'
      },
      pest: {
        title: 'रोग व कीट पहचान AI',
        desc: 'संक्रमित पत्तियों की तस्वीर खींचकर AI से तुरंत सटीक निदान व उपचार पाएं।',
        badge: 'विजन AI',
        route: '/predict'
      },
      recommend: {
        title: 'मिट्टी व फसल सिफारिश',
        desc: 'मिट्टी के N-P-K और मौसम के आधार पर अधिकतम उपज देने वाली फसलों की सिफारिश।',
        badge: 'स्मार्ट सलाह',
        route: '/recommend'
      },
      mandi: {
        title: 'लाइव मंडी भाव व मैप',
        desc: 'भारत की सभी एपीएमसी मंडियों के वास्तविक समय भाव और लाइव मैप।',
        badge: 'लाइव भाव',
        route: '/market-prices'
      },
      weather: {
        title: 'इको-वेदर पूर्वानुमान',
        desc: '500 मीटर की सटीकता के साथ हाइपर-लोकल मौसम पूर्वानुमान व छिड़काव अलर्ट।',
        badge: 'मौसम AI',
        route: '/chat'
      },
      subsidies: {
        title: 'सरकारी योजनाएं व सब्सिडी',
        desc: 'PM-KISAN, फसल बीमा (PMFBY) और खाद-बीज सब्सिडी की स्मार्ट पात्रता जांच।',
        badge: 'सरकारी योजनाएं',
        route: '/schemes'
      },
      multilingual: {
        title: 'WhatsApp AI बॉट',
        desc: 'WhatsApp पर 24/7 अपनी भाषा में वॉइस, फोटो और लोकेशन के साथ कृषि सलाह पाएं।',
        badge: 'व्हाट्सएप बॉट',
        route: '/whatsapp'
      }
    }
