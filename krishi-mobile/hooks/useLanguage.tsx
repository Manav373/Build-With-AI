...
export const UIStringsByLang: Record<LanguageKey, UIStrings> = {
  en: {
    ...
    menu_satellite: 'Satellite', menu_irrigation: 'Smart Farm (IoT)', menu_settings: 'Settings',
  ...
  hi: {
    ...
    menu_satellite: 'सैटेलाइट', menu_irrigation: 'स्मार्ट फार्म (IoT)', menu_settings: 'सेटिंग्स',
  ...
  gu: {
    ...
    menu_satellite: 'સેટેલાઇટ', menu_irrigation: 'સ્માર્ટ ફાર્મ (IoT)', menu_settings: 'સેટિંગ્સ',
  ...
  mr: {
    ...
    menu_satellite: 'सॅटेलाइट', menu_irrigation: 'स्मार्ट फार्म (IoT)', menu_settings: 'सेटिंग्ज',
  ...
  ta: {
    ...
    menu_satellite: 'செயற்கைக்கோள்', menu_irrigation: 'ஸ்மார்ட் பண்ணை (IoT)', menu_settings: 'அமைப்புகள்',
  ...
  te: {
    ...
    menu_satellite: 'ఉపగ్రహం', menu_irrigation: 'స్మార్ట్ ఫార్మ్ (IoT)', menu_settings: 'సెట్టింగ్‌లు',
  ...
  kn: {
    ...
    menu_satellite: 'ಉಪಗ್ರಹ', menu_irrigation: 'ಸ್ಮಾರ್ಟ್ ಫಾರ್ಮ್ (IoT)', menu_settings: 'ಸೆಟ್ಟಿಂಗ್‌ಗಳು',
  ...
  bn: {
    ...
    menu_satellite: 'স্যাটেলাইট', menu_irrigation: 'স্মার্ট খামার (IoT)', menu_settings: 'সেটিংস',
  ...
  pa: {
    ...
    menu_satellite: 'ਸੈਟੇਲਾਈਟ', menu_irrigation: 'ਸਮਾਰਟ ਫਾਰਮ (IoT)', menu_settings: 'ਸੈਟਿੰਗਾਂ',
  ...
  ml: {
    ...
    menu_satellite: 'സാറ്റലൈറ്റ്', menu_irrigation: 'സ്മാർട്ട് ഫാം (IoT)', menu_settings: 'ക്രമീകരണങ്ങൾ',
